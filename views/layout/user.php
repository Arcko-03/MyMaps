		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="/<?=WEBROOT2?>/accueil/userindex">Accueil <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item">
			...
			<div class="navbar-brand" style="width:50%; font-size: 30px">
				  <a href="/<?=WEBROOT2?>"><img src="/<?=WEBROOT2?>/webroot/img/logohorizontal.png" width="165px"></a> user version
				</div>
