...
<center><h1><?=$titre?></h1></center>
	...
	if ($empty == 'false'){	
		...
		echo '<div class="col-sm"><a href="/'.WEBROOT2.'/lieus/adminview/'.$p->id.'">En savoir plus</a></div>';
		echo '</div>';
		echo '</div><br><br>';

		}

		echo "<br><center><a href='/".WEBROOT2."/lieus/adminedit/".$p->idP."' style='color:#E26D5C;'><i class='fas fa-plus-circle fa-3x' ></i></a></center>";
	}
	else{
		echo "<br>";
		echo "<br>";
		...
		echo "<br><center><a href='/".WEBROOT2."/lieus/adminedit' style='color:#E26D5C;'><i class='fas fa-plus-circle fa-3x' ></i></a></center><br>";
	}
